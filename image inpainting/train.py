...
G_optimizer = optim.Adam(netG.parameters(), lr=0.0005, betas=(0.5, 0.9))


criterion = InpaintingLossWithGAN(args.logPath, VGG16FeatureExtractor(), lr=0.00005, betasInit=(0.0, 0.9), Lamda=10.0)
...
for i in range(1, num_epochs + 1):
    ...
    for inputImgs, GT, masks in train_bar:
