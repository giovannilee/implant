...
class LBAMModel(nn.Module):
    ...
    def forward(self, inputImgs, masks):
        # print("1st input", inputImgs.shape)
        # print("1st mask", masks.shape)
        ...
        # print("forwordmap1", forwardMap1.shape)
        # print("forwordmap2", forwardMap2.shape)
        # print("forwordmap3", forwardMap3.shape)
        # print("forwordmap4", forwardMap4.shape)
        # print("forwordmap5", forwardMap5.shape)
        # print("forwordmap6", forwardMap6.shape)
        # print("ef7", ef7.shape)
        # print("reverse mask",(1 - masks).shape)
        ...
        # print("reverseMap1", reverseMap1.shape)
        # print("reverseMap2", reverseMap2.shape)
        # print("reverseMap3", reverseMap3.shape)
        # print("reverseMap4", reverseMap4.shape)
        # print("reverseMap5", reverseMap5.shape)
        # print("reverseMap6", reverseMap6.shape)
     
        # print("skipConnect6", skipConnect6.shape)
        concatMap6 = torch.cat((forwardMap6, reverseMap6), 1)
        dcFeatures1 = self.dc1(skipConnect6, ef7, concatMap6)

        # print("concatMap6", concatMap6.shape)
        # print("dcFeatures1", dcFeatures1.shape)
        ...
        # print("dcFeatures6", dcFeatures6.shape)
        dcFeatures7 = self.dc7(dcFeatures6)
        # print("dcFeatures7", dcFeatures7.shape)
